...
//@Composable
//fun CartScreen(navController: NavController,cartItems: MutableList<Item>) {
//    Scaffold(
//        topBar = {
//            TopAppBar(
...
//        ) {
//            items(CardWithShapeProvider().values.toList()) { item ->
//                CardWithShape(
//                    item.id,
//                    item.title,
//                    item.description,
    ...
    Scaffold(
        ...
        if (cartItems.isEmpty()) {
            ...
            LazyVerticalGrid(
                ...
                items(cartItems) { item -> // Use cartItems instead of CardWithShapeProvider().values.toList()
                    CardWithShape(
                        navController,
                        item,
